...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state ={
            ...
            logo: "",
            editMode: false, 
            apiUrl: "https://samsmith.devcamp.space/portfolio/portfolio_items", 
            apiAction: 'post'
        }
        ...
        this.handleLogoDrop = this.handleBannerDrop.bind(this);
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://samsmith.devcamp.space/portfolio/portfolio_items/${id}`, 
                apiAction: "patch", 
